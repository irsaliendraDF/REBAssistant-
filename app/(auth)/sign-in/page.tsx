  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-md flex-col justify-center px-6 py-16">
      <div className="mb-10">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-slate-900">REB Assistant</h1>
        <p className="mt-3 text-sm leading-relaxed text-slate-600">
          Prepare a Research Ethics Board application, section by section. REB Assistant helps you
          draft and spot gaps. It does not decide whether your application will be approved.
        </p>
      </div>
      ...
      {env.app.usePlaceholderAuth ? (
        <div className="rounded-lg border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900">
          ...
          <p className="mt-1 leading-relaxed">
            Local build only. Email magic link replaces this when the hosted project is connected.
          </p>
        </div>
      ) : null}
